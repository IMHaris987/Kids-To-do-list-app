package com.example.kidstodolist.ui.createcard
...
import com.example.kidstodolist.ui.voiceinput.VoiceInputFragment
...
class CreateCardActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.example.kidstodolist.R.layout.activity_create_card)

        imagePreview = findViewById(com.example.kidstodolist.R.id.imagePreview)

        val ivBack = findViewById<ImageView>(com.example.kidstodolist.R.id.ivBack)
        val cardTake = findViewById<CardView>(com.example.kidstodolist.R.id.card_take)
        val cardChoose = findViewById<CardView>(com.example.kidstodolist.R.id.card_choose)
